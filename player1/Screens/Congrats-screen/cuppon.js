export class Congratulations {
    ...
    sketch(p) {
        p.setup = () => {
            ...
            title.style('text-align', 'center'); // Center text
            ...
            let orangecheck = p.createImg('./Screens/imgs/Blue_Check.jpg', 'save');
            ...
            couponCode.style('text-align', 'center'); // Center text
            ...
            this.saveCouponBtn.style('margin', '10% auto'); // Center button horizontally
            this.saveCouponBtn.style('display', 'block'); // Make it a block element
